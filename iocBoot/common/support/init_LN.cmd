...
# ===========================================
# Channel 0
$(CH0_MPS=#)dbLoadRecords("db/amc_ai${UND}.db","P=${CH0_P},ATTR=${CH0_R},EGU=${CH0_EGU},BAY=0,INP=0,TPR=$(TPR),IOC=${IOC_NAME},BSA=${BEAMPATH}")
...
# Channel 1
$(CH1_MPS=#)dbLoadRecords("db/amc_ai${UND}.db","P=${CH1_P},ATTR=${CH1_R},EGU=${CH1_EGU},BAY=0,INP=1,TPR=$(TPR),IOC=${IOC_NAME},BSA=${BEAMPATH}")
...
# Channel 2
$(CH2_MPS=#)dbLoadRecords("db/amc_ai${UND}.db","P=${CH2_P},ATTR=${CH2_R},EGU=${CH2_EGU},BAY=0,INP=2,TPR=$(TPR),IOC=${IOC_NAME},BSA=${BEAMPATH}")
...
# Channel 3
$(CH3_MPS=#)dbLoadRecords("db/amc_ai${UND}.db","P=${CH3_P},ATTR=${CH3_R},EGU=${CH3_EGU},BAY=1,INP=0,TPR=$(TPR),IOC=${IOC_NAME},BSA=${BEAMPATH}")
...
# Channel 4
$(CH4_MPS=#)dbLoadRecords("db/amc_ai${UND}.db","P=${CH4_P},ATTR=${CH4_R},EGU=${CH4_EGU},BAY=1,INP=1,TPR=$(TPR),IOC=${IOC_NAME},BSA=${BEAMPATH}")
...
# Channel 5
$(CH5_MPS=#)dbLoadRecords("db/amc_ai${UND}.db","P=${CH5_P},ATTR=${CH5_R},EGU=${CH5_EGU},BAY=1,INP=2,TPR=$(TPR),IOC=${IOC_NAME},BSA=${BEAMPATH}")
