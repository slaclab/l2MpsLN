...
$(CH0_MPS=#)L2MPSASYNRegisterFault("${CH0_P}:I0_${CH0_R}",0)
$(CH0_MPS=#)L2MPSASYNRegisterFault("${CH0_P}:I1_${CH0_R}",6)
...
$(CH1_MPS=#)L2MPSASYNRegisterFault("${CH1_P}:I0_${CH1_R}",1)
$(CH1_MPS=#)L2MPSASYNRegisterFault("${CH1_P}:I1_${CH1_R}",7)
...
$(CH2_MPS=#)L2MPSASYNRegisterFault("${CH2_P}:I0_${CH2_R}",2)
$(CH2_MPS=#)L2MPSASYNRegisterFault("${CH2_P}:I1_${CH2_R}",8)
...
$(CH3_MPS=#)L2MPSASYNRegisterFault("${CH3_P}:I0_${CH3_R}",3)
$(CH3_MPS=#)L2MPSASYNRegisterFault("${CH3_P}:I1_${CH3_R}",9)
...
$(CH4_MPS=#)L2MPSASYNRegisterFault("${CH4_P}:I0_${CH4_R}",4)
$(CH4_MPS=#)L2MPSASYNRegisterFault("${CH4_P}:I1_${CH4_R}",10)
...
$(CH5_MPS=#)L2MPSASYNRegisterFault("${CH5_P}:I0_${CH5_R}",5)
$(CH5_MPS=#)L2MPSASYNRegisterFault("${CH5_P}:I1_${CH5_R}",11)
