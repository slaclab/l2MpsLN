...
$(CH0_MPS=#)L2MPSASYNRegisterFault("${CH0_P}:I0_${CH0_R}")
$(CH0_MPS=#)L2MPSASYNRegisterFault("${CH0_P}:I1_${CH0_R}")
...
$(CH1_MPS=#)L2MPSASYNRegisterFault("${CH1_P}:I0_${CH1_R}")
$(CH1_MPS=#)L2MPSASYNRegisterFault("${CH1_P}:I1_${CH1_R}")
...
$(CH2_MPS=#)L2MPSASYNRegisterFault("${CH2_P}:I0_${CH2_R}")
$(CH2_MPS=#)L2MPSASYNRegisterFault("${CH2_P}:I1_${CH2_R}")
...
$(CH3_MPS=#)L2MPSASYNRegisterFault("${CH3_P}:I0_${CH3_R}")
$(CH3_MPS=#)L2MPSASYNRegisterFault("${CH3_P}:I1_${CH3_R}")
...
$(CH4_MPS=#)L2MPSASYNRegisterFault("${CH4_P}:I0_${CH4_R}")
$(CH4_MPS=#)L2MPSASYNRegisterFault("${CH4_P}:I1_${CH4_R}")
...
$(CH5_MPS=#)L2MPSASYNRegisterFault("${CH5_P}:I0_${CH5_R}")
$(CH5_MPS=#)L2MPSASYNRegisterFault("${CH5_P}:I1_${CH5_R}")
