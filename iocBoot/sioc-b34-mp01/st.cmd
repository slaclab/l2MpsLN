...
epicsEnvSet("PREFIX_MPS_BAY0","MPLN:B034:BAY0")

# PV nama prefix, for the application on Bay 1
epicsEnvSet("PREFIX_MPS_BAY1","MPLN:B034:BAY1")
...
cpswLoadConfigFile("/data/sioc-b34-mp03/configs/app_db/cpu-bsyh-sp01/0000/02/config.yaml","mmio")
...
dbLoadRecords("db/mps_blm.db",   "P=SOLN:B034:212, BAY=0, INP=0, PORT=${L2MPSASYN_PORT}")
dbLoadRecords("db/mps_blm.db",   "P=SOLN:B034:823, BAY=0, INP=1, PORT=${L2MPSASYN_PORT}")
dbLoadRecords("db/mps_scale_factor.db", "P=SOLN:B034:212,PROPERTY=I0,EGU=,PREC=4,VAL=1")
dbLoadRecords("db/mps_scale_factor.db", "P=SOLN:B034:823,PROPERTY=I0,EGU=,PREC=4,VAL=1")
